# ADR-019 — why I froze the Gen2.4 bounded-mass Fluxrib
...
I froze 1.14 mm active magnetic ribs, unchanged 1.00 mm copper rungs, 1.20 mm finished rib width
and 1.60 mm matching stator slots. I reduced the three-turn primary point slightly to 1,190 A-turn.
I accepted an 8.60 g miss against the 0.30 kg interface preference while retaining the 0.40 kg
absolute limit unchanged.

## Why I chose it

I treated this as a bounded payload-side purchase: 9.49 g more magnetic matrix than Gen2.3 buys peak-flux
