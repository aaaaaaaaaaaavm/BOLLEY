# ADR-013 — why I froze the Gen2.1 Fluxmanifold field candidate
...
I froze **Fluxmanifold** for the next formal field gate: a 28 mm stationary face, 7.3 mm outer
legs, 7 mm back yoke and 3 mm circular return haunch feeding the same four passive cage blades.
I spread blade pitch to 4 mm while keeping the payload-side projection unchanged.

I chose a copper-neutral turn exchange: three 27 mm² turns at 1,280 A-turn instead of four 20.25 mm²
