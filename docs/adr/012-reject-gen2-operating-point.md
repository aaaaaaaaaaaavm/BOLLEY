# ADR-012 — why I rejected the A3g Gen2 point after an independent field solution
...
I rejected A3g `p30_B0.56` as the Gen2 operating point. I preserve A3g and A5d as optimisation and
packaging evidence, but I do not use their drive, source-energy or thermal results as current
baseline values.

I retained the passive Fluxbridge cage and the A5d envelope as the starting point for Gen2.1. I
redesigned the stationary return path first; I did not try to recover field by current alone while
the core was already above its limit. I required another independent field and circuit closure
before transient cage-force, tip-off or thermal campaign work.
