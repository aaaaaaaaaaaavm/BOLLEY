# ADR-001: why I accepted a cooperative payload interface
...
I allow Bolley to add a passive, launcher-specific rail interface to the spacecraft. The Phase 0 target
is no more than 0.25 kg and the hard limit is 0.40 kg.

I do not accept spacecraft power, permanent magnets, pressure systems, pyrotechnics or launch-time
software as part of this decision.
