# ADR-025 — freeze the five-lane Gen2.6 Quintweb
...
Freeze five Fluxweb blades per face on a 31 mm R4 stationary return. Use four 20.25 mm2 turns at
375 A for 1,500 A-turn. Scale payload capture allowance with blade count and keep the 0.40 kg
absolute interface limit unchanged.

Revise only A6g's inductance upper band from 1.05 to 1.40 times A3g before the formal run. The
