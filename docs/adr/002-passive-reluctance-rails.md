# ADR-002: why I chose an active stator and passive reluctance rails
...
I chose a segmented long-primary reluctance machine with the windings on the launcher and passive
